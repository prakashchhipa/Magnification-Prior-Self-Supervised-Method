...
def finetune_Effnet_b2(train_data_fold, test_data_fold, magnification, model_path, LR, epoch, description):
    ...
    downstream_task_model.model._fc = nn.Sequential(nn.Dropout(0.5), nn.Linear(1408, 1))
...
if __name__ == "__main__":
    ...
    finetune_Effnet_b2(args.train_data_fold, args.test_data_fold, args.magnification, args.model_path, args.LR, args.epoch, args.description)
